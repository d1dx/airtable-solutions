# Get Select Options with IDs

Author: Daniel Rudaev (D1DX)

Extracts single or multiple select field options with their IDs.

## Usage

Interactive script with user prompts for table, field, and output format selection.
